...
echo $this->Form->input('averageTradeDiscountEbook', array('class'=>'input1', 'value'=>30, 'label'=>array('class'=>'label1')));
echo $this->Form->input('distributionRate', array('class'=>'input1', 'value'=>27, 'label'=>array('class'=>'label1')));
echo $this->Form->input('advertisingRate', array('class'=>'input1', 'value'=>7, 'label'=>array('class'=>'label1')));
echo $this->Form->input('forcastRightsIncome', array('class'=>'input1', 'value'=>0, 'label'=>array('class'=>'label1')));
