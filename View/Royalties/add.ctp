...
<?php
    ...
    echo $this->Form->input('startingRate', array('class'=>'input_im', 'label'=>array('class'=>'label1', 'text'=>'Royalty Rate - Starting Rate*')));
    ...
    echo $this->Form->input('rightsIncomeSplit', array('class'=>'input_im', 'label'=>array('class'=>'label1', 'text'=>'Rights Income Split*')));
